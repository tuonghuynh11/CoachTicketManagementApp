    ...
    <View style={styles.root}>
      ...
      >
        ...
        <View style={styles.iconActivity}>
          ...
          <Text style={[styles.date, { marginTop: 0 }]}> {duration} </Text>
        </View>
      ...
      {shuttle && (
        <View style={[styles.service, { gap: 10 }]}>
          <View
            style={{
          ...
          <View
            style={{
              backgroundColor: GlobalColors.background_input,
              padding: 5,
              borderRadius: 10,
            }}
          >
            <Text style={{ fontSize: 15, fontWeight: "600", color: "white" }}>
              {shuttle.departurePlace.length <= 30
                ? shuttle.departurePlace
                : shuttle.departurePlace.slice(0, 20) + "..."}
            </Text>
          </View>
        </View>
      )}
      ...
      >
        ...
        >
          {addDotsToNumber(subTotal)} VND
        </Text>{" "}
      </Text>
    </View>
  );
}
export default RecheckSchedule;
