                ...
                >
                  ...
                  <View style={{ gap: 5 }}>
                    ...
                    >
                      {
                        route?.params?.trackingInfo?.ShuttleRouteData
                          ?.ShuttleData?.DriverData?.fullName
                      }
                    </Text>
                    <Text
                      style={{
                    ...
                    >
                      {
                        route?.params?.trackingInfo?.ShuttleRouteData
                          ?.ShuttleData?.DriverData?.phoneNumber
                      }
                    </Text>
                  </View>
                </View>
                ...
                >
                  ...
                  <View style={{ gap: 5, marginLeft: -5 }}>
                    ...
                    >
                      {
                        route?.params?.trackingInfo?.ShuttleRouteData
                          ?.ShuttleData?.CoachAssistantData?.fullName
                      }
                    </Text>
                    <Text
                      style={{
                    ...
                    >
                      {
                        route?.params?.trackingInfo?.ShuttleRouteData
                          ?.ShuttleData?.CoachAssistantData?.phoneNumber
                      }
                    </Text>
                  </View>
                </View>
                ...
                <View style={styles.rowStyle}>
                  ...
                  <View style={{ gap: 5 }}>
                    ...
                    >
                      {
                        route?.params?.trackingInfo?.ShuttleRouteData
                          ?.ShuttleData?.CoachData?.coachNumber
                      }
                    </Text>
                  </View>
                </View>
...
export default ShuttleTrackingScreen;
